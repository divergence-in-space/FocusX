  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "pulse-glow": {
          "0%, 100%": { boxShadow: "0 0 20px hsl(180 100% 50% / 0.2)" },
          "50%": { boxShadow: "0 0 40px hsl(180 100% 50% / 0.4)" },
        },
        "float": {
        ...
        "glow-pulse-strong": {
          "0%, 100%": {
            boxShadow: "0 0 15px rgba(0, 234, 255, 0.2), 0 0 30px rgba(180, 120, 255, 0.1)",
          },
          "50%": {
            boxShadow: "0 0 30px rgba(0, 234, 255, 0.4), 0 0 60px rgba(180, 120, 255, 0.2)",
          },
        },
        "shimmer": {
